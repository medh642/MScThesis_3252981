...
def generate_code_for_query(query, persist_dir=PERSIST_DIR, collections=COLLECTIONS):
...
### BATCH RUN 
def run_as_batch(input_json, output_json):
    ...
    for item in queries:
        ...
        llm_response, context = generate_code_for_query(query)
...
if __name__ == "__main__":
    run_as_batch(PROJECT_PATH+r"\queries.json", PROJECT_PATH + r"\generated_code.json")